...
class TestDepthLimit:
    ...
    def test_max_depth_is_three(self):
        ...
        from proofpack.spawner.registry import MAX_DEPTH

        assert MAX_DEPTH == 3

    def test_can_spawn_at_depth_zero(self):
        """DEPTH: root spawn (depth 0) allowed."""
        from proofpack.spawner.recursion import can_spawn_child
    ...
    def test_lineage_tracking(self, monkeypatch):
        ...
        from proofpack.spawner.recursion import get_lineage
        from proofpack.spawner.registry import AgentType, register_agent
