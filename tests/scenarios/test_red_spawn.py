...
class TestRedSpawn:
    ...
    def test_red_spawn_formula(self):
        ...
        from spawner.birth import calculate_helper_count
    ...
    def test_red_minimum_one_helper(self):
        ...
        from spawner.birth import calculate_helper_count, MIN_HELPERS
    ...
    def test_red_maximum_six_helpers(self):
        ...
        from spawner.birth import calculate_helper_count, MAX_HELPERS
    ...
    def test_red_high_variance_bonus(self):
        ...
        from spawner.birth import calculate_helper_count, HIGH_VARIANCE_THRESHOLD
    ...
    def test_red_ttl_300s(self, monkeypatch):
        ...
        from spawner.birth import spawn_for_gate
        from spawner.registry import get_agent, DEFAULT_TTL_SECONDS
